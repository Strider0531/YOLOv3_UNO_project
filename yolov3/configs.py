...
TRAIN_CLASSES               = "model_data/UNO_names.txt"
TRAIN_ANNOT_PATH            = "model_data/UNO_train.txt"
TRAIN_LOGDIR                = "log"
TRAIN_CHECKPOINTS_FOLDER    = "checkpoints"
TRAIN_MODEL_NAME            = f"{YOLO_TYPE}_custom_UNO"
...
# TEST options
TEST_ANNOT_PATH             = "model_data/UNO_test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
